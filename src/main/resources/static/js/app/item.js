	...
	$("#itemReadBtn").on("click", function() {
		$.ajax({
			...
			success : function(data) {
				...
				var str ="<img src='items/display?itemId=" + data.itemId + "&timestamp=" + new Date().getTime() + "' width='210'>";
				
				$("#preview").append(str);
				
				$("#preview2").empty();
				
				var str2 ="<img src='items/preview?itemId=" + data.itemId + "&timestamp=" + new Date().getTime() + "' width='210'>";
